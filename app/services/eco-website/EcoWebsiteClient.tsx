...
import {
    ...
    Search, ShieldCheck, Mail, Phone, User, Briefcase, ChevronRight, ChevronLeft, Code2, Settings, MessageSquare, Building2,
                ...
                >
                    ...
                    >
                        {[
                            ...
                            { label: "Personal Brands", icon: Zap },
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-20 items-center relative z-10">
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5 mb-10">
                            {[
                                { text: "Optimized Images for fast load", icon: Zap },
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        {[
                            ...
                            { label: "Custom Design Upgrade", icon: Zap },
